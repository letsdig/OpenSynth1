...
> **OpenSynth1** is an open-source Virtual Analog and FM Synthesizer plugin (VST3) and standalone application, inspired by Ichiro Toda's legendary **Synth1** and the classic **Clavia Nord Lead 2** hardware architecture. Built using modern C++ and the JUCE framework.

![OpenSynth1 Preview](assets/screenshot_01_main_ui.png)

> [!WARNING]
> **Experimental / AI-Generated Code Disclaimer**:
> All source code in this repository—including DSP algorithms, audio synthesis architecture, JUCE structure, custom vector GUI, and preset handling—was **100% generated by Artificial Intelligence (AI)**.
> This software is currently **experimental and has not undergone extensive debugging** or exhaustive production testing. Use at your own risk. Feedback, testing reports, and contributions are welcome!
